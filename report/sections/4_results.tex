...
% only 2 recordings
In total, only 2 overnight EEG sleep recordings (from 2 different subjects DESCRIBE THEM???) were used in the pipeline during the course of this project. However, as was described, the pipeline is prepared to receive more data, and obtaining the predictions for them is streamlined. 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{Images/comparisson1_predictionsCM.png}
    \vspace{-0.8em}
...
Both metrics were also the same between any of the predictions with different window sizes from model 1 and the predictions from model 2 (0.88 agreement and 0.82 kappa score). 
